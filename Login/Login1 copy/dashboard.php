...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Performance Dash | by Wavelength</title>
...
<body>
  <nav>
    <div class="navbar">
      <div class="logo"><a href="#">Student's Dash</a></div>
      <ul class="nav-links">
        <li><a href="home.html">Home</a></li>
        <li><a href="about.html">About</a></li>
        <li><a href="per.html">Skills</a></li>
  ...
  <section class="home-content">
    <div class="texts">
    <h3 class="text"> <span>Engineering</span> &amp; <span>Technology</span> </h3>
      <p>Our programs offer students a platform for academic<br>
      excellence with subjects that are constructed to provide<br>
      equal emphasis on theoretical and practical exposure.</p>
      <h2 class="text">Make your Performance Better</h2>
      <h3 class="text">With <span>Performance_Dash</span></h3>
      <p></p>
      <div class="button">
      <a href="marks.html">Explore Me
